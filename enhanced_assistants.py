...
##### Inputs #####
# TODO add inputs of existing agents + threads to extend a conversation
...
message_content = """Build me a locally run tool to allow me to store information about my friends in an RDB.
Let your engineer decide the easiest way to do it. Make sure there are CLI functions to easily add, modify, and delete entries.
And a locally hosted UI that actually lets me create a new table. Don't ask me any more questions. Start working with E."""
